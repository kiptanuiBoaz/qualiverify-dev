                        ...
                        <Grid item xs={12} md={6}>
                            ...
                            <Stack direction="row" spacing={6}>
                                ...
                                <Box sx={{ borderRadius: "10px", border: "2px solid #20447A", p: 2 }}>
                                    <Typography sx={{ fontSize: 14, fontWeight: 800, fontFamily: '"Libre Baskerville",sans-serif;' }} color="primary">Email us</Typography>
                                    <Typography sx={{ fontSize: 16, fontWeight: 400, fontFamily: '"Libre Baskerville",sans-serif;' }} color="primary">qualifverify@mail.com</Typography>
